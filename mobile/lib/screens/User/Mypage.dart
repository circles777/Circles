...
class Mypage extends HookWidget {
  ...
  //ユーザー情報
        Padding(
          ...
          child:ColumnViewWithGap(gap: 8, children:[
    Text('基本情報',
    style:TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color.fromRGBO(
                      0, 0, 0, 1))),
    RowViewWithGap(gap: 8, children: [
    Text('学校名:',
    style:TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color.fromRGBO(
                      0, 0, 0, 1))),
    Text('東京理科大学',
    style:TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color.fromRGBO(
                      0, 0, 0, 1)))          
  ...
  Tag(name: 'キャンピング', backgroundColor: Color.fromRGBO(68,165,255,0.8)),
  Tag(name: 'アウトドア', backgroundColor: Color.fromRGBO(68,165,255,0.8)),
  Tag(name: '自然', backgroundColor: Color.fromRGBO(68,165,255,0.8)),
  Tag(name: 'ゆったり', backgroundColor: Color.fromRGBO(68,165,255,0.8)),
  Tag(name: '自然', backgroundColor: Color.fromRGBO(68,165,255,0.8)),
  Tag(name: 'キャンピング', backgroundColor: Color.fromRGBO(68,165,255,0.8)),
  Tag(name: 'ゆったり', backgroundColor: Color.fromRGBO(68,165,255,0.8)),
  Tag(name: 'アウトドア', backgroundColor: Color.fromRGBO(68,165,255,0.8)),
